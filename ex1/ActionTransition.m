function [A] = ActionTransition(taskname, previous, current,action_name, time)
% This function produces the sigmoid function to activate or deactivate tasks
...
if ismember(taskname, current) && strcmp(taskname, "V") && strcmp(action_name, "manip")
    A = 1;
